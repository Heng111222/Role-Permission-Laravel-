                    ...
                    <form action="{{ route('article.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title') }}"
                                class="form-control w-50 rounded-2" placeholder="Enter Title">
                            @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="text" id="text" class="form-control w-50 rounded-2" placeholder="Enter Content" rows="5">{{ old('text') }}</textarea>
                            @error('text')
                                <p class="text-danger mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="author" id="author" value="{{ old('author') }}"
                                class="form-control w-50 rounded-2" placeholder="Enter Author">
                            @error('author')
                                <p class="text-danger mt-1">{{ $message }}</p>
                            @enderror
                        </div>
